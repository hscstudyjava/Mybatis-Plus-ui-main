...
import { isNumber } from '@/utils/verify/index.ts'
  ...
  >
    <template #header="{ close }">
      <div class="relative h-54px flex items-center justify-between pl-15px pr-15px">
        ...
        >
        <el-icon v-if="isFullscreen"    class="is-hover mr-10px cursor-pointer">
        ...
        <el-icon v-else    class="is-hover mr-10px cursor-pointer">
