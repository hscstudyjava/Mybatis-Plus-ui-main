<template>
    <div :class="{ 'has-logo': isLogo }" :style="{
        backgroundColor: settingStore.sideTheme === 'theme-dark'
        ...
        <el-scrollbar :class="settingStore.sideTheme" wrap-class="scrollbar-wrapper">
            ...
            <el-menu :default-active="activeMenu" :collapse="sibebarOpen"
                ...
                :unique-opened="true" :active-text-color="settingStore.themeColor" :collapse-transition="false"
                mode="vertical">

                <!-- <sidebar-item v-for="(route, index) in sidebarRouters" :key="route.path + index" :item="route"
                    :base-path="route.path" /> -->
                <sub-item v-for="(route, index) in sidebarRouters" :key="route.path + index" :item="route"
                    :base-path="route.path" />
            </el-menu>
        </el-scrollbar>
    </div>
